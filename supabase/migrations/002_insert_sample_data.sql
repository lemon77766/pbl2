-- 插入示例作者数据
INSERT INTO authors (name, biography, dynasty) VALUES
...
('白居易', '白居易（772年－846年），字乐天，号香山居士，唐代伟大的现实主义诗人。', '唐代'),
('李商隐', '李商隐（约813年－约858年），字义山，号玉谿生，晚唐著名诗人。', '唐代'),
('杜牧', '杜牧（803年－约852年），字牧之，号樊川居士，晚唐杰出诗人。', '唐代'),
('王之涣', '王之涣（688年－742年），唐代著名边塞诗人。', '唐代'),
('张若虚', '张若虚（约660年－约720年），唐代诗人，与贺知章、张旭、包融并称"吴中四士"。', '唐代'),
('辛弃疾', '辛弃疾（1140年－1207年），字幼安，号稼轩，南宋豪放派词人。', '宋代'),
('陆游', '陆游（1125年－1210年），字务观，号放翁，南宋著名诗人。', '宋代'),
('柳永', '柳永（约984年－约1053年），原名三变，字景庄，北宋著名词人。', '宋代'),
('晏殊', '晏殊（991年－1055年），字同叔，北宋著名文学家。', '宋代'),
('欧阳修', '欧阳修（1007年－1072年），字永叔，号醉翁，北宋文学家。', '宋代'),
('王安石', '王安石（1021年－1086年），字介甫，号半山，北宋著名政治家、文学家。', '宋代'),
('秦观', '秦观（1049年－1100年），字少游，号淮海居士，北宋词人。', '宋代'),
('周邦彦', '周邦彦（1056年－1121年），字美成，号清真居士，北宋词人。', '宋代'),
('姜夔', '姜夔（约1155年－约1221年），字尧章，号白石道人，南宋词人。', '宋代');
...
BEGIN
    ...
    FROM poems p
    JOIN authors pa ON p.author_id = pa.id
    WHERE 
        to_tsvector('chinese', p.title || ' ' || p.content || ' ' || pa.name) 
        @@ plainto_tsquery('chinese', search_term)
